 ...
 *
 */
public class ImprovedPositionRankKeyword3 extends KeywordExtractor {
	...
	public ImprovedPositionRankKeyword3(Segment defaultSegment) {
		super(defaultSegment);
	}

	public ImprovedPositionRankKeyword3() {
	}
	...
	public static List<String> getKeywordList(String document,
			int size) {
		ImprovedPositionRankKeyword3 improvedPositionRankKeyword3 =
				new ImprovedPositionRankKeyword3();

		return improvedPositionRankKeyword3.getKeywords(document, size);
	}
	...
	public static List<String> getKeywordList(String title,
		...
		return improvedPositionRankKeyword3.getKeywords(title, document,
				size);
	}
		...
		for (int i = 0; i < titleWordList.size(); i++) {
			...
			if (!wordCountMap.containsKey(titleWordList.get(i))) { // 不包含的情况
				wordCountMap.put(titleWordList.get(i),
						(titleWordList.size() - titlePosition++) * 1.0f
								/ titleWordList.size());
			} else { // 包含的情况
				wordCountMap.put(titleWordList.get(i), wordCountMap
						.get(titleWordList.get(i))
						+ (titleWordList.size() - titlePosition++)
