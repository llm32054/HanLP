 ...
 *
 */
public class ImprovedPositionRankKeyword extends KeywordExtractor {
	...
	public ImprovedPositionRankKeyword(Segment defaultSegment) {
		super(defaultSegment);
	}

	public ImprovedPositionRankKeyword() {
	}
	...
	public static List<String> getKeywordList(String document,
			int size) {
		ImprovedPositionRankKeyword improvedPositionRankKeyword =
				new ImprovedPositionRankKeyword();

		return improvedPositionRankKeyword.getKeywords(document, size);
	}
	...
	public static List<String> getKeywordList(String title,
		...
		return improvedPositionRankKeyword.getKeywords(title, document,
				size);
	}
