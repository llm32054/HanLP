 ...
 *
 */
public class ImprovedPositionRankKeyword4 extends KeywordExtractor {
	...
	public ImprovedPositionRankKeyword4(Segment defaultSegment) {
		super(defaultSegment);
	}

	public ImprovedPositionRankKeyword4() {
	}
	...
	public static List<String> getKeywordList(String document,
			int size) {
		ImprovedPositionRankKeyword4 improvedPositionRankKeyword4 =
				new ImprovedPositionRankKeyword4();

		return improvedPositionRankKeyword4.getKeywords(document, size);
	}
	...
	public static List<String> getKeywordList(String title,
		...
		return improvedPositionRankKeyword4.getKeywords(title, document,
				size);
	}
