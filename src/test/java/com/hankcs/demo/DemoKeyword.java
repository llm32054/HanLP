...
public class DemoKeyword
{
     ...
     * @return
     */
    public static List<String> textRankKeyWord(String content, int size){
     ...
     * @return
     */
    public static List<String> positionRankKeyWord(String content, int size){
        return HanLP.extractKeywordByPositionRank(content, size);
    }
}
