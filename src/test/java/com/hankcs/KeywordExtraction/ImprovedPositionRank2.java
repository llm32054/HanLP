 ...
 *
 */
public class ImprovedPositionRank2 {
	/**
	 * 测试集所在文件夹
	 */
	 ...
	 */
	public static String improvedPositionRank2ResultFile =
			Global.improvedPositionRank2ResultFile;
	...
	public static List<String> improvedPositionRankKeyWord2(
		...
		return HanLP.extractKeywordByImprovedPositionRank2(title,
				content, size);
	}

	public static void main(String[] args) {
		// 输出关键词提取结果至文本文件
		Keyword2Txt(testDataSetDir, improvedPositionRank2ResultFile);
	}
