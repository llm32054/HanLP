 ...
 *
 */
public class ImprovedPositionRank4 {
	/**
	 * 测试集所在文件夹
	 */
	 ...
	 */
	public static String improvedPositionRank4ResultFile =
			Global.improvedPositionRank4ResultFile;
	 ...
	 * @return
	 */
	public static List<String> improvedPositionRankKeyWord4(
			String title, String content, int size) {
		return HanLP.extractKeywordByImprovedPositionRank4(title,
				content, size);
	}

	public static void main(String[] args) {
		// 输出关键词提取结果至文本文件
		Keyword2Txt(testDataSetDir, improvedPositionRank4ResultFile);
	}
